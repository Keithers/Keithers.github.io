(function () {
    window.psAudio = function(obj){
        ...
        $('#audio').append($('<audio id="audio-my" src="" preload="metadata"></audio><div class="audio-head"></div><div class="add"></div><div class="min-time" style="display:none"></div><div class="audio-img"></div><div class="audio-text"></div><div class="audio-by"></div><div class="audio-btn"></div><div class="audio-sound"></div>'));
        ...
        for(var i = 1; i < audioName.length; i++){
            if(obj.audioLic[i]){
